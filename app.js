...
window.addEventListener('load', ()=>{
    speak("Activating program");
    speak("Welcome to Nandha engineering college");
    wishMe();
})
...
function speakThis(message) {
    ...
    if(message.includes('hai') || message.includes('hello')) {
        const finalText = "Hello Indhira, how can i help you";
        speech.text = finalText;
    }

    else if(message.includes('goodbye')) {
        const finalText = "okay bye,see you soon";
        speech.text = finalText;
    }
